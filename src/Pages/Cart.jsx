    ...
    <>
      ...
      <div className="flex justify-center  bg-gray-200">
        <div className="max-w-[91%] mr-4  p-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-4 border bg-white border-gray-400 p-2">
              ...
              <div className="w-full  flex justify-between items-center p-4">
                <button className="px-3 py-1 border border-gray-400 rounded text-white bg-blue-700">
                  - Back to shop
                </button>
                <button
                  className="px-3 py-1 border border-gray-400 rounded text-blue-500 bg-white"
                  onClick={RemoveAll}
                >
                  Remove all
                </button>
            ...
            <div>
              <div className="p-4 h-fit border border-gray-400 mb-4 bg-white">
                <p>Have a coupon</p>
                <div className="w-[90%] border border-gray-400 mt-3 h-[40px] rounded flex justify-between px-4 items-center">
                  Add coupon <button className="border-l pl-4 h-full">Apply</button>
                </div>
              </div>
              <div className="border border-gray-400 rounded-lg p-4 h-fit bg-white">
          ...
          <div className="w-[66%] flex justify-between h-[80px]  mt-4">
            <div className=" max-w-md rounded-md px-4 py-3 flex items-center gap-3 cursor-pointer">
              {/* Icon */}
          ...
          <div className="mt-8">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              {currentSaved.map((item) => (
                <div
                  key={item.id}
                  className="border border-gray-400 rounded-lg p-3 text-center bg-white"
                >
                  ...
                  <div className="flex justify-center cursor-pointer gap-2 w-[80%] m-auto text-blue-500 border mt-2">
                      <ShoppingCartOutlinedIcon />
                    <button className="cursor-pointer text-sm  px-2">
                      Move to cart
                    </button>              
                  </div>
                </div>
