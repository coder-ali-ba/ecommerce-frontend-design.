          ...
          {currentItems.map(item => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p>Size: medium, Color: blue,  Material: PlasticSeller: Artel Market</p>
                <div className="mt-2">
                  <button className="py-1 px-3 bg-white text-red-500 border border-gray-300 rounded" 
                  onClick={()=>handleRemove(item.id)}>Remove</button>
                  <button className="py-1 px-3 bg-white ml-3 text-blue-500 border border-gray-300 rounded" 
                  onClick={()=>handleSave(item.id)}>Save for later</button>
                </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
          {currentSaved.map(item => (
            <div key={item.id} className="border rounded-lg p-3 text-center">
              ...
              />
              <p className="text-sm font-medium">Regular Fit Resort Shirt</p>
              <p className="font-semibold">$57.70</p>

              <div className="flex justify-center gap-2 mt-2">
                <button className="text-blue-600 text-sm">Move to cart</button>
